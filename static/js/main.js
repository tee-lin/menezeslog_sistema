...
// Versão 2.0.0 - Integração Digital Ocean + Supabase
// Data: 2025-06-09
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar formulário de login - buscar por diferentes IDs possíveis
    const loginForm = document.getElementById('login-form') || document.querySelector('form');
    if (loginForm) {
        loginForm.addEventListener('submit', async function(e) {
            e.preventDefault();
            
            // Buscar campos de email/usuário e senha por diferentes IDs/names
            ...
            if (!emailField || !passwordField) {
                logMenezes('Campos de login não encontrados', 'error');
            ...
            if (!email || !password) {
                logMenezes('Email e senha são obrigatórios', 'error');
        ...
        logMenezes('Formulário de login configurado', 'success');
    } else {
        logMenezes('Formulário de login não encontrado', 'warning');
    }
    ...
    if (logoutBtn) {
        ...
        logMenezes('Botão de logout configurado', 'success');
    }
...
logMenezes('MenezesLog v2.0.0 carregado com sucesso!', 'success');
